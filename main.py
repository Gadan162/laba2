...
# Генерация случайных комплексных матриц размера n x n
...
# Функция для умножения матриц с использованием cblas_zgemm
def matrix_multiply_blas(A, B):
    return FB.zgemm(alpha=1.0, a=A, b=B, trans_b=True)
...
matrix1 = generate_random_complex_matrix(n)
matrix2 = generate_random_complex_matrix(n)
